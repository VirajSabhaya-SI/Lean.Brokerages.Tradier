...
namespace QuantConnect.Brokerages.Tradier
{
    ...
    public partial class TradierBrokerage
    {
        ...
        {
            return (symbol.ID.SecurityType == SecurityType.Equity || symbol.ID.SecurityType == SecurityType.Index
+                || symbol.ID.SecurityType == SecurityType.Option || symbol.ID.SecurityType == SecurityType.IndexOption)
